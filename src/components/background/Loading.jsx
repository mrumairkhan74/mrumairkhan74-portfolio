  ...
  return (
    <div className="relative w-full min-h-screen bg-transparent">
      <img
        ...
        alt=""
      />
      <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-1/2 spin2  bg-transparent rounded-[50%] p-16 border-7 border-t-blue-800 border-r-purple-800 border-l-0 border-b-0 "></span>
